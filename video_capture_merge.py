...
with col2:
    if st.button("CAPTURE PICTURE (Click Here)"):
        ret, frame = cap.read()
        if ret:
            ...
            st.write("Failed to capture picture. Please try again.")
...
if len(emotion_list) > 0:
    ...
    # Filter dataframe based on detected emotion
    recommended_songs = df_1[df_1['Emotional'] == detected_emotion].head(
        15)  # Assuming you want to display top 10 recommendations
